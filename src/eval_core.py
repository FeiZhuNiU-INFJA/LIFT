...
def _build_judge_prompt(agent_result: str, content_reqs: str) -> str:
    return (
        "你是严格评测器。请根据【任务期望结果】判定当前任务是否已经完成。\n"
...
def eval_task(task: BenchmarkTask, run_id: str, agent: Agent) -> bool:
    # 初始化 FornaxUdfTags
